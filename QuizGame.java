...
String director = JOptionPane.showInputDialog("Question 2: Who is the current director of Gompers Preparatory Acadmey?");
...
String possible = JOptionPane.showInputDialog("Question : If everything is possible, is it possible \n for something to be impossible?");
